...
do -- menu
    function UI:Notification(message, duration, color, player)
        ...
        local base_position = Vector2.new(0.5, 1)
        local notification_spacing = 30
        ...
        function notification:remove()
            ...
            table.remove(UI.notifications, index)

            notif_ui:Destroy()

            for i, notif in ipairs(UI.notifications) do
                local targetY = bottom_offset - ((i - 1) * notification_spacing)
        ...
        task.spawn(function()
            ...
            local targetY = bottom_offset - ((#UI.notifications - 1) * notification_spacing)
            ...
            for _, v in next, notification.Objects do
                if v:IsA("Frame") then
                    ...
                    tween_service:Create(
                        v,
                        TweenInfo.new(0.45, Enum.EasingStyle.Quart),
    ...
    do -- window
        function UI:window(options)
            ...
            local imagetoptab = Instance_manager.new("ImageLabel", {
                ...
                BorderSizePixel = 0;
                ZIndex = 9999;
                Image = "http://www.roblox.com/asset/?id=96750709662390";
            });
