...
local CoreGui = nil
if game.Players.LocalPlayer.PlayerGui:FindFirstChild("CustomChat") then
	CoreGui = game.Players.LocalPlayer.PlayerGui:FindFirstChild("CustomChat")
else
	local CustomChat = Instance.new("ScreenGui")
	CustomChat.Name = "CustomChat"
	CustomChat.Parent = game.Players.LocalPlayer.PlayerGui
	CoreGui = CustomChat
end
...
function library:Init(Config)
	...
	tabButtons.BackgroundTransparency = 1.00
	...
	function library:NewTab(title)
		...
		function Components:NewSeperator()
			...
			sectionFrame.BackgroundTransparency = 0.75
			sectionFrame.ClipsDescendants = true
